...
def main(params):
    ...
    opts.checkpoint_freq = 0 # disable automatic checkpoint as it will be handled by SaverTrainer (we don't need to save models for LoaderTrainer) 
    ...
    rf_game = core.SymbolGameReinforce(rf_sender, rf_receiver, cross_entropy, opts.sender_entropy_coeff)
